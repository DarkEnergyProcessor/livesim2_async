...
local function createGlowScore(blur)
	...
	util.setStencilTest11("less", 1)
	util.stencil11(function() love.graphics.rectangle("fill", 44, 44, 872, 8) end, "increment")
	love.graphics.draw(a)
...
function lwui:drawHeader()
	...
	util.stencil11(self.staminaStencil, "increment")
